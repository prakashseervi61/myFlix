...
const MovieListItemSkeleton = () => {
  return (
    <div className="flex bg-gray-900/50 border border-gray-800 rounded-lg overflow-hidden">
      <div className="w-24 sm:w-28 flex-shrink-0 bg-gray-800"></div>
      <div className="flex-1 p-3 sm:p-4 flex flex-col justify-between animate-pulse">
        ...
        <div className="flex items-center gap-2 sm:gap-3 mt-4">
          ...
          <div className="h-7 bg-gray-700 rounded-md w-20"></div>
          <div className="h-7 bg-gray-700 rounded-md w-20"></div>
        </div>
      </div>
    </div>
