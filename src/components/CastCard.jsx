...
const CastCard = ({ actor }) => {
  return (
    <div className="flex-shrink-0 w-[125px] md:w-[140px] group cursor-pointer scroll-snap-align-start transition-all duration-300 hover:-translate-y-1">
      <div className="relative aspect-square overflow-hidden rounded-xl mb-3 shadow-lg bg-gray-900 border border-white/5">
        {actor.profile_path ? (
          <img 
      ...
      <div className="space-y-1">
        <h4 className="text-white font-bold text-[13px] leading-tight group-hover:text-cyan-400 transition-colors line-clamp-2">
          {actor.name}
        </h4>
