    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="bg-surface border border-muted/20 shadow-2xl rounded-2xl p-8 sm:p-10 w-full max-w-[448px] relative z-10 fade-in-up">
        <div className="text-center mb-8">
          ...
          <p className="text-muted/70 mt-2">Enter the cinematic universe</p>
        </div>
          ...
          <div className="space-y-2">
            <input
              ...
              className={`w-full p-4 bg-background/50 text-white rounded-xl border focus:outline-none focus:ring-2 transition-all duration-300 placeholder:text-muted/40 ${
                errors.name ? 'border-red-500 focus:ring-red-500/20 focus:border-red-500' : 'border-muted/30 focus:border-primary focus:ring-primary/20'
              }`}
            />
            {errors.name && <p className="text-red-400 text-xs mt-1 px-1">{errors.name.message}</p>}
          </div>
        ...
        <div className="text-center mt-8">
          <p className="text-muted/70">
            ...
            <Link to="/login" className="text-primary hover:underline transition-colors font-bold">
              Access Account
            </Link>
          </p>
        </div>
